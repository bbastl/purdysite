...
CREATE TABLE order_details (
    ...
    expirymonth character varying(255),
    expiryyear character varying(255),
    status character varying(255),
    shippingnumber character varying(255),
    shippingmethod character varying(255),
    shippingpriority character varying(255),
    shippingcarrier character varying(255),
    auth_status character varying(255),
    auth_by character varying(255),
    auth_date character varying(255),
    auth_time character varying(255),
    note character varying(255),
    sn_flag character varying(255),
    fld_date date,
    fld_time character varying(255),
    project character varying(255),
    eau character varying(255),
    production_start character varying(255),
    decision_maker character varying(255),
    decision_title character varying(255),
    prototype_date character varying(255),
    buying_criteria character varying(255),
    target_price character varying(255),
    how_did character varying(255),
    competition1 character varying(255),
    competition2 character varying(255),
    competition3 character varying(255),
    competition4 character varying(255),
